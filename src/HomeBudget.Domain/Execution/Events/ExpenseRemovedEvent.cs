...
/// <summary>
/// Represents the event raised when an expense entry is soft-removed from a budget.
/// </summary>
/// <param name="BudgetId">The identifier of the budget.</param>
/// <param name="ExpenseId">The identifier of the removed expense.</param>
...
/// <param name="RemovedOnUtc">The date and time when the expense was removed in UTC.</param>
public sealed record ExpenseRemovedEvent(
    BudgetId BudgetId,
    ExpenseId ExpenseId,
